...
import static com.nisira.core.util.Encryption.encrypt;
import static com.nisira.core.util.Encryption.decrypt;
...
//        char[] charPassword = cadena.toCharArray()
    ...
    public static void main(String[] args) {
        ...
        String desencripter=Desencriptar_ASCII(encrypt);
